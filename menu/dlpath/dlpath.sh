...
variable /psa/var/hd.path "/mnt"
psapath=$(cat /psa/var/hd.path)

used=$(df -h $psapath | tail -n +2 | awk '{print $3}')
capacity=$(df -h $psapath | tail -n +2 | awk '{print $2}')
percentage=$(df -h $psapath | tail -n +2 | awk '{print $5}')
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
🌎  PSA Processing Disk Interface
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

🌵  Processing Disk : $psapath
    Processing Space: $used of $capacity | $percentage Used Capacity

☑️   PSA does not format your second disk, nor mount it! We can
only assist by changing the location path!

☑️   Enables PSA System to process items on a SECONDARY Drive rather
...
🌵  Current Processing Disk : $psapath

☑️   Type the path as show in the examples below! PSA will then attempt
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
☠  BONEHEAD:  PSA Fixed the Paths For You... (read next time)
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
ansible-playbook /psa/psablitz/menu/installer/main.yml
bash /psa/psablitz/menu/dlpath/rebuild.sh
...
You may have forgotten to create it, but PSA is unable to see it!
