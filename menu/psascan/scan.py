                    ...
                    <div class="col-md-auto text-center" style="padding-top: 10px;">
                        ...
                        <form action="" method="post">
                            <div class="input-group mb-3" style="width: 600px;">
                                <input class="form-control" type="text" name="filepath" value="" required="required" placeholder="Path to scan e.g. /psa/unity/Media/Movies/Movie Name (year)/" aria-label="Path to scan e.g. /psa/unity/Media/Movies/Movie Name (year)/" aria-describedby="btn-submit">
